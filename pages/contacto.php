...
<head>
  ...
  align-items: center;
  padding: 60px 20px;
  background:rgba(0,0,0,0.5); /* gris claro como contraste */
}
...
.form-group textarea:focus {
  border: 1px solid #009ee3; /* azul de tu estilo */
  outline: none;
}
...
<main class="contacto-container">
  <section class="contacto-form">
    <h2>Contacto</h2>
    <p class="intro">¿Tenés dudas, consultas o querés hacer un pedido especial? Escribinos y te responderemos lo antes posible.</p>
    ...
    <form action="enviar_contacto.php" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="text" id="asunto" name="asunto" placeholder="Tema de tu consulta" required>
      </div>
